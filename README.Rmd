...
source(file = here("scripts/00_newSimsFramework_15012026.R"))
```
...
Note also the Rhat stats for the two model runs. The global SE parameter, `theta`, has not converged. The same behaviour has been observed with an empirical dataset.
