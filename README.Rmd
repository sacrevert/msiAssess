...
```
Look at Rhat stats for `msiAssess` model run (not available for BRCIndicators; see issue [here](https://github.com/BiologicalRecordsCentre/BRCindicators/issues/90).)
